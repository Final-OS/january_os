...
#[inline]
fn read_user_u64(ptr: usize) -> Result<u64, i32> {
    validate_user_range(ptr, core::mem::size_of::<u64>())?;
    Ok(unsafe { core::ptr::read(ptr as *const u64) })
}

#[inline]
fn write_user_u64(ptr: usize, value: u64) -> Result<(), i32> {
    validate_user_range(ptr, core::mem::size_of::<u64>())?;
    unsafe {
...
fn read_user_sigaction(ptr: usize) -> Result<RtSigAction, i32> {
    validate_user_range(ptr, core::mem::size_of::<RtSigAction>())?;
    Ok(unsafe { core::ptr::read(ptr as *const RtSigAction) })
}
...
fn write_user_sigaction(ptr: usize, value: RtSigAction) -> Result<(), i32> {
    validate_user_range(ptr, core::mem::size_of::<RtSigAction>())?;
    unsafe {
        core::ptr::write(ptr as *mut RtSigAction, value);
    }
    Ok(())
}
