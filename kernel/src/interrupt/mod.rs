...
pub use arch::x86_64::controller::apic::{
    ...
    ICR_DEST_LOGICAL, ICR_DEST_PHYSICAL, ICR_LEVEL_ASSERT, ICR_LEVEL_DEASSERT,
    ICR_SHORTHAND_ALL, ICR_SHORTHAND_ALL_BUT_SELF, ICR_SHORTHAND_NONE, ICR_SHORTHAND_SELF,
